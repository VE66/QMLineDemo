...
Pod::Spec.new do |s|
  s.name             = 'QMLineUI'
  s.version          = '0.1.0'
  s.summary          = 'A short description of QMLineDemo.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = "QMLineSDK UI"

  s.homepage         = 'https://github.com/VE66/QMLineDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'VE66' => '942914231@qq.com' }
  s.source           = { :git => 'https://github.com/VE66/QMLineDemo.git', :tag => s.version.to_s }
  ...
  s.source_files = 'QMLineUI/Classes/**/*'
   ...
   s.public_header_files = 'QMLineUI/Classes/QMChatUI/**/*.h'
   s.frameworks = 'UIKit'
